...
my_data1$Years <- my_data1$YearsAtCompany + my_data1$YearsInCurrentRole + my_data1$YearsSinceLastPromotion + my_data1$YearsWithCurrManager
```
...
prettyPlot(fi_all.mean1, 
           ...
           new.plot = FALSE)
```
* Component 1: No significant inference 
...
## Confidence Interval and Mean of the I-Map
